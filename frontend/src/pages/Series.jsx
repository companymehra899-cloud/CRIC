...
export default function Series() {
  ...
  return (
    <div>
      ...
      {list.map((s) => (
        <Link to={`/series/${s.id}`} className="league-row" key={s.id} style={{ background: 'var(--card)', border: '2px solid var(--border)', borderRadius: 15, padding: 16, marginBottom: 10, boxShadow: 'var(--shadow)' }}>
